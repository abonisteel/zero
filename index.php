        ...
        <main>
            ...
            <section>
                ...
                <div id="slideshow">
                    ...
                    <img class="slide" src="images/og-run-1.jpg" alt="Runners Running Down the Road">
                    <img class="slide" src="images/og-swim-1.jpg" alt="Swimmers Entering Water">
                </div>
            ...
            <section>
                ...
                <!-- Weather Feed -->
                <a class="weatherwidget-io" href="https://forecast7.com/en/45d52n122d68/portland/?unit=us" data-label_1="PORTLAND" data-label_2="WEATHER" data-font="Roboto" data-icons="Climacons Animated" data-theme="clear">PORTLAND WEATHER</a>
                <script>
                    ! function(d, s, id) {
